...
const en = {
  ...
  title: 'InPlace: check invoices against orders, before you pay',
  description:
  ...
  what: {
    ...
    demoHint: 'The product screens are the English edition of the application. Select a station to walk the chain.',
    steps: [
      {
        k: 'Purchase order',
      ...
      },
      {
        ...
        img: 'assets/screen-office-receiving-en.webp',
      ...
      },
      {
        ...
        img: 'assets/screen-owner-payment-requests-en.webp',
