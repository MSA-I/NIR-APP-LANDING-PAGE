...
const en = {
  ...
  title_page: {
    folio: 'Cover',
    eyebrow: 'Procurement, invoices and payments. Built in Hebrew.',
    h1: 'Everything between the order and the&nbsp;money, in one place.',
    lede: [
      'InPlace connects the business procurement workflow into one chain: supplier, price list, purchase order, goods received, invoice, approval and payment. Every incoming document receives a row, a status and a link to the order it came from.',
      'The system compares what you ordered, what arrived and what you were asked to pay. A mismatch stops and waits for a decision instead of surfacing after month end.',
    ],
  ...
  what: {
    ...
    steps: [
      ...
      {
        k: 'Goods received',
        t: 'Goods received are recorded against the order',
  ...
  midAsk: {
    line: 'That is everything the system does. Open an account and start with one supplier.',
  },

  why: {
    folio: 'Chapter 03: why this approach',
    h2: 'Why not a spreadsheet, and why not an&nbsp;ERP',
    lede: 'Today the work is split between a spreadsheet, WhatsApp, the accountant and a supplier ordering system. InPlace replaces that split with one journey, one source of truth and clear ownership at every step.',
