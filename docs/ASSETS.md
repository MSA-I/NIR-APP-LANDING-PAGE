...
| 3 | 5945c439-d049-4158-9f03-ce4d29851f8f | seedance_2_0 | image-to-video: start+end = S1 (seamless loop), motion-only prompt per Seedance guide (front-loaded, ~45 words, one camera move, "preserve composition and colors") | **APPROVED + SHIPPED**: still's composition preserved in motion; 1920x1080, 8.04s, measured with ffprobe. Derived files encoded and live in public/media/. |
